...
public class RobotMap {
	public static CANTalon R_FRONT_MOTOR = new CANTalon(1);
	public static CANTalon R_REAR_MOTOR = new CANTalon(2);
	public static CANTalon L_FRONT_MOTOR = new CANTalon(3);
	public static CANTalon L_REAR_MOTOR = new CANTalon(4);
	public static VictorSP L_LIFT_MOTOR = new VictorSP(0);
